...
class MyHome0820 extends StatelessWidget {
  @override
...
class _MyPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // size => CustomPaint가 가지고 있는 크기 => 부모위젯으로 부터 물려 받은 크기

    // Paint 객체 : 붓, 색상, 두께, 끝 둥글게 등 처리
    Paint brush = Paint();
    ...
    for (var i = 0; i < values.length; i++) {
      ...
      brush.color = color;
      canvas.drawArc(rect, startAngle, sweepAngle, true, brush);
